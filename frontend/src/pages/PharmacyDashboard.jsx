...
const PharmacyDashboard = ({ account, consentContract, auditLogContract, accessContract, medicalRecordsContract }) => {
    ...
    return (
        <div className="dashboard animate-fade-in" style={{ padding: '2rem' }}>
            ...
            {decryptedRx && (
                <div className="dashboard-section surface-card" style={{ marginTop: '2rem', padding: '2rem', borderTop: '4px solid var(--primary-color)' }}>
                    ...
                    <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '1.5rem', display: 'flex', justifyContent: 'flex-end', gap: '1rem' }}>
                        ...
                        <button className="primary-btn" onClick={handleDispense} disabled={isDispensing} style={{ background: 'var(--success-color)' }}>
            ...
            {dispensedId && (
                <div className="dashboard-section surface-card" style={{ marginTop: '2rem', padding: '2rem', borderTop: '4px solid var(--success-color)', textAlign: 'center' }}>
                    <h3 style={{ color: 'var(--success-color)', marginBottom: '0.5rem' }}>✅ Dispensation Logged Successfully</h3>
