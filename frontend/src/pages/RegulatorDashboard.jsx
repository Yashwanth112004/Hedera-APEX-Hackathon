      ...
      {selectedTab === 'overview' && (
        <div className="dashboard-section surface-card">
          ...
          <div className="compliance-grid">
            <div className="compliance-card" style={{ background: 'var(--bg-surface-2)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)', padding: '1.5rem' }}>
              <h4 style={{ marginBottom: '1rem', color: 'var(--text-primary)' }}>Consent Management</h4>
              <div className="compliance-metric">
                <span className="metric-label" style={{ color: 'var(--text-secondary)' }}>Consent Rate:</span>
                <span className="metric-value" style={{ fontWeight: '700', color: 'var(--success-color)' }}>94.2%</span>
              </div>
              <div className="compliance-metric" style={{ marginTop: '0.5rem' }}>
                <span className="metric-label" style={{ color: 'var(--text-secondary)' }}>Average Duration:</span>
                <span className="metric-value" style={{ fontWeight: '700', color: 'var(--primary-color)' }}>45 days</span>
              </div>
            </div>
            <div className="compliance-card" style={{ background: 'var(--bg-surface-2)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)', padding: '1.5rem' }}>
              <h4 style={{ marginBottom: '1rem', color: 'var(--text-primary)' }}>Data Access</h4>
              <div className="compliance-metric">
                <span className="metric-label" style={{ color: 'var(--text-secondary)' }}>Authorized Access:</span>
                <span className="metric-value" style={{ fontWeight: '700', color: 'var(--primary-color)' }}>1,247</span>
              </div>
              <div className="compliance-metric" style={{ marginTop: '0.5rem' }}>
                <span className="metric-label" style={{ color: 'var(--text-secondary)' }}>Unauthorized Attempts:</span>
                <span className="metric-value" style={{ fontWeight: '700', color: 'var(--danger-color)' }}>3</span>
              </div>
            </div>
            <div className="compliance-card" style={{ background: 'var(--bg-surface-2)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)', padding: '1.5rem' }}>
              <h4 style={{ marginBottom: '1rem', color: 'var(--text-primary)' }}>Erasure Requests</h4>
              <div className="compliance-metric">
                <span className="metric-label" style={{ color: 'var(--text-secondary)' }}>Requests Received:</span>
                <span className="metric-value" style={{ fontWeight: '700', color: 'var(--accent-color)' }}>47</span>
              </div>
              <div className="compliance-metric" style={{ marginTop: '0.5rem' }}>
                <span className="metric-label" style={{ color: 'var(--text-secondary)' }}>Processed:</span>
                <span className="metric-value" style={{ fontWeight: '700', color: 'var(--success-color)' }}>45</span>
              </div>
            </div>
          </div>
        </div>
